  ...
  return (
    <div style={{ textAlign: "center" }}>
      ...
      <Row xs="auto" className="justify-content-center">
        ...
        <input  type="number" value={count} min="0" max="12" step="1" style={{width:"60px"}} onChange={HandleChangeCount} />
         </Col>
        <Col>
      ...
      <Row>
        ...
        <br></br>
         <div className="d-flex justify-content-around mt-2">
             <Button variant="dark" disabled={count==0} style={{ width: "400px", height: "80px"}}><h4>Comenzar</h4></Button>
         </div>
...
const PasEspPage = () => {
  ...
  return (
      ...
      <Container className="d-flex justify-content-center align-items-center min-vh-20">
        ...
        >
          <Card.Body>
            <h1 className="mb-1">Fotos de Pasaporte Español</h1><h4 className="mb-4">(26x32 mm)</h4>
            <Row>
              <Col md={6}>
               <Image
              src={image}
            ...
            <div className="d-flex justify-content-around mt-2 mb-4">
              ...
              <Col md={6}>
               { (image!=template) && <FormPasEsp></FormPasEsp> }
              </Col>
            </Row>
